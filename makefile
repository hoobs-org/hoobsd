...
hoobsd-amd64: clean lint paths package build hoobsd-amd64.yaml
	nice $(as_root) vmdb2 --verbose cache/amd64.yaml --output=cache/amd64.img --log build.log
...
hoobsd-arm64: clean lint paths package build hoobsd-arm64.yaml
	nice $(as_root) vmdb2 --verbose cache/arm64.yaml --output=cache/arm64.img --log build.log
...
hoobsd-armhf: clean lint paths package build hoobsd-armhf.yaml
	nice $(as_root) vmdb2 --verbose cache/armhf.yaml --output=cache/armhf.img --log build.log
