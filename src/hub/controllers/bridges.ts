...
export default class BridgesController {
    constructor() {
        State.app?.get("/api/bridges", (request, response, next) => Security(request, response, next), (request, response) => this.list(request, response));
        State.app?.put("/api/bridges", (request, response, next) => Security(request, response, next), (request, response) => this.create(request, response));
        State.app?.get("/api/bridges/count", (request, response) => this.count(request, response));
        State.app?.post("/api/bridges/import", (request, response, next) => Security(request, response, next), (request, response) => this.import(request, response));
        State.app?.post("/api/bridge/:id", (request, response, next) => Security(request, response, next), (request, response) => this.update(request, response));
        State.app?.post("/api/bridge/:id/ports", (request, response, next) => Security(request, response, next), (request, response) => this.ports(request, response));
        State.app?.get("/api/bridge/:id/export", (request, response, next) => Security(request, response, next), (request, response) => this.export(request, response));
