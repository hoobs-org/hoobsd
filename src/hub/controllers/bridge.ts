...
export default class BridgeController {
    constructor() {
        State.app?.get("/api/bridge", (request, response, next) => Security(request, response, next), (request, response) => this.all(request, response));
        State.app?.get("/api/bridge/:bridge", (request, response, next) => Security(request, response, next), (request, response) => this.status(request, response));
        State.app?.post("/api/bridge/:bridge/start", (request, response, next) => Security(request, response, next), (request, response) => this.start(request, response));
        State.app?.post("/api/bridge/:bridge/stop", (request, response, next) => Security(request, response, next), (request, response) => this.stop(request, response));
        State.app?.post("/api/bridge/:bridge/restart", (request, response, next) => Security(request, response, next), (request, response) => this.restart(request, response));
    }
